...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		titleHtml =
			...
			htmlEscape(event.title.substr(0,11))+
  			'<span style="color:red; font-size:11px;">'+ // 시간 뒤 (0/0) 빨간색으로 처리
  			  htmlEscape(event.title.substr(11,5))+ // we always want one line of height	
  			'</span>'+
			'</span>';
