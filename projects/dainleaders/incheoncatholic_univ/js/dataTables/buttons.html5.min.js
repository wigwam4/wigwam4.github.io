(function(j) {
    ...
    m.ext.buttons.copyHtml5 = {
        className: "buttons-copy buttons-html5 btn btn-sm btn-default",
        text: function(a) {
            return a.i18n("buttons.copy", "&nbsp;복사")
        },
    ...
    m.ext.buttons.csvHtml5 = {
        bom: !1,
        className: "buttons-csv buttons-html5 btn btn-sm btn-default",
        available: function() {
    ...
    m.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5 btn btn-sm btn-default",
        available: function() {
    ...
    m.ext.buttons.pdfHtml5 = {
        className: "buttons-pdf buttons-html5 btn btn-sm btn-default",
        available: function() {
